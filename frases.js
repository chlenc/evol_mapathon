...
module.exports = {
    start(name) {
        return ('Привет, '+name+'!\n' +
            ...
            '\n' +
            'Следующим сообщением мы отправим тебе правила, которые необходимо соблюдать, чтобы успешно завершить марафон и получить результат. ' +
            ' Ты всегда их сможешь посмотреть нажав кнопку "правила" в меню.👇\n')
    },
